...
module.exports = function (req, res) {
    ...
    function getFilters(userDetails) {
        ...
        if (!userDetails) {
            ...
            /* Marital Status for Self and partner starts */
            ...
            /* Marital Status for Self and partner ends */

            /* No of Children for Self and partner starts */
            ...
            /* No of Children for Self and partner ends */

            /* Religion for Self and partner start */
            ...
            /* Religion for Self and partner ends */

            /* Cast for Self and partner starts */
            ...
            /* Cast for Self and partner ends */

            /* Native State for Self and partner starts */
    ...
    function searchData(userDetails, finalCriteria) {
        ...
        db.getAll('user', where, {}, function (filteredUsers) {
            if (!filteredUsers) {
                var output = {responseCode: 402, responseMsg: 'Data not found We Match'};
                res.json(output);
                res.end();
                return false;
            } else {
