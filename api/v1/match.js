...
module.exports = function (req, res) {
        ...
        db.getAll('privacySettings', wherePrivacy, {to: 1}, function (toUsers) {
            ...
            if (!toUsers) {
                ...
                if (type == 2) {
                    ...
                    if (userDetails.filters.noOfChildren > 0) {
    ...
    function searchData(userDetails, finalCriteria, matches) {
        ...
        db.getAll('user', where, {}, function (totalUsers) {
            if (!totalUsers) {
                var output = {responseCode: 402, responseMsg: 'Data not found My Matches'};
                res.json(output);
                res.end();
            } else {
                model.searchUserMatch('user', where, page, limit, function (searchResult) {
                    ...
                    if (!searchResult || searchResult.length <= 0) {
                        ...
                        var output = {responseCode: 200, responseMsg: 'Search result for My Match'};
